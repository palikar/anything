...
class PlaneHelper : public Entity
{
  ...
  public:
    PlaneHelper(glm::vec3 color = {1.0f, 1.0f, 1.0f}, size_t size = 1)
        : m_proj_mat(), m_proj_mat_inv(glm::inverse(m_proj_mat))
    {
        ...
        // m_transform->transform.scale() = glm::vec3(20,20,20);
    }
    ...
    void init_points()
    {
        ...
        auto mat = grph::solid_color(1.0f, 0.0f, 0.0f);
        ...
        cmp::add_children(
            this,
            line_segments_entity({ std::move(lines_geom),  grph::solid_color(1.0f, 0.0f, 0.0f)}),
